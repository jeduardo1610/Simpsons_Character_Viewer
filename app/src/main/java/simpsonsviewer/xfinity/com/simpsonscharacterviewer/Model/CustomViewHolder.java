...
import simpsonsviewer.xfinity.com.simpsonscharacterviewer.Controller.CustomVolleyRequest;
import simpsonsviewer.xfinity.com.simpsonscharacterviewer.Controller.ViewDialog;
...
public class CustomViewHolder extends RecyclerView.ViewHolder{
    ...
    public CustomViewHolder(View itemView, Context context, Activity activity) {
        super(itemView);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    alert.showDialog(activity, detail,urlImage,image,name);
